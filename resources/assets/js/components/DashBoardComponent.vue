    ...
    <div>
        ...
        <div class="col-md-12">
            <div class="search-form search-body col-sm-12 col-md-12" id="searchForm">
                <form id="searchForm" name="searchForm" class="form-horizontal" @submit.prevent="search">
                    <div class="row">
                        <div class="col-md-2 col-sm-12" v-bind:class="{'has-error': (errors.department_id != '') }">
                        ...
                        <div class="col-md-2 col-sm-12" v-bind:class="{'has-error': (errors.staff_id != '') }">
                        ...
                        <div class="col-md-3 col-sm-12" v-bind:class="{'has-error': (errors.customer_id != '') }">
                        ...
                        <div class="col-md-2 col-sm-12" v-bind:class="{'has-error': (errors.sales_date != '') }">
                            <label>対象月</label>
        ...
        <div class="col-md-12 col-sm-12">
            <div id="board-container" class="flex-container">
                ...
                <!-- <div id="f-contents-2" name="f-contents">
                    <subdashboard-component
                        :orderNo="2"
                    ></subdashboard-component>
                </div>

                <div id="f-contents-3" name="f-contents">
                    <subdashboard-component
                        :orderNo="3"
                    ></subdashboard-component>
                </div> -->
...
export default {
    ...
    created: function() {
        ...
        if (this.queryparam.length > 1) {
            ...
            if (this.searchParams.sales_date == "") { this.searchParams.sales_date = null };
        } else {
            // 初回の検索条件をセット
            ...
            if (sender.selectedValue) {
                ...
                if (this.staffDepartmentList[sender.selectedValue]) {
                    tmpStaff = this.staffList.filter(rec => {
                        return (this.staffDepartmentList[sender.selectedValue].indexOf(rec.id) !== -1)
                    });
                }
            }
        ...
        changeIdxStaff: function (sender) {
            ...
            if (sender.selectedValue) {
                ...
                for (var key in this.customerList) {
                    if (sender.selectedValue == this.customerList[key].charge_staff_id && 
                        (this.wjSearchObj.department_id.selectedValue == null ? true : this.wjSearchObj.department_id.selectedValue == this.customerList[key].charge_department_id)) 
                    {
