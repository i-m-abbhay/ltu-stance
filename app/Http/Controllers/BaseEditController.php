 ...
 * 拠点編集
 */
class BaseEditController extends Controller
{
    const SCREEN_NAME = 'base-edit';
    ...
    public function save(Request $request)
    {
        ...
        try {
            ...
            if ($newFlg) {
                // 登録
                $saveResult = $Base->add($params);
                $delLock = true;
            } else {
                // 更新
                $saveResult = $Base->updateById($params);
    ...
    public function delete(Request $request)
    {
        ...
        try {
            ...
            // 削除
            $deleteResult = $Base->deleteById($params['id']);
    ...
    private function isValid($request)
    {
        $this->validate($request, [
            'base_name' => 'required|max:30',
            'base_short_name' => 'max:10',
            'zipcode' => 'max:7',
            'address1' => 'max:50',
            'address2' => 'max:50',
            'latitude_jp' => 'numeric',
